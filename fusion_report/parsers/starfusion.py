...
class Starfusion(AbstractFusionTool):
    ...
    def set_header(self, header: str, delimiter: str | None = "\t") -> None:
        ...
        Args:
            header: Raw header string read from the STAR-Fusion output file.
    ...
    def parse(self, line: str, delimiter: str | None = "\t") -> List[Tuple[str, Dict[str, Any]]]:
        """Parse one data line from a STAR-Fusion output file.

        Extracts the fusion name, breakpoint positions, read support metrics,
